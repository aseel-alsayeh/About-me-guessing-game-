...
let Names = ['abdalla', 'aseel', 'ahmad', 'ali', 'asem', 'ala'];
let q7 = prompt('guess the name that start with (A) letter :( abdalla , aseel , ahmad , sara , 34 , true) ) ');
let flag = false;
function test(){
    ...
    for (let i = 0; i < 6 ; i++) {
        ...
        if(q7 === Names[i]){
             alert(' correct answer : ' + q7);
             console.log("correct");
             flag = true;
             break;} 
              
              else{q7 = prompt('try again')}
              
         }
          if (i = 5){ alert('you spent all your chances sorry')}
        }
...
// if (flag === false) {
//     console.log(" sorry all attempts are wrong");
//     alert("sorry all attempts are wrong ");
// }

alert(" all correct answers are : abdalla , aseel  and ahmad");
